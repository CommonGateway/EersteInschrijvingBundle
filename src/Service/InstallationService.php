...
class InstallationService implements InstallerInterface
{
    ...
    {
        $this->logger->debug("EersteInschrijvingBundle -> Install()");
    ...
    {
        $this->logger->debug("EersteInschrijvingBundle -> Update()");
    ...
    {
        $this->logger->debug("EersteInschrijvingBundle -> Uninstall()");
